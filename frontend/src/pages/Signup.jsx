...
const Signup = () => {
  ...
  return (
    <div className="h-screen w-full px-5 flex items-center justify-center radial">
      <div className="flex flex-col px-8 py-8 md:px-10 items-center gap-8 max-w-[500px] w-full bg-white rounded-lg">
